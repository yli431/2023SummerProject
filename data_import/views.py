...
# from .models import AverageRentalGrowth, FamilyIncome, House, HouseValueGrowth, MeanHouseValueSuburbsCHCH, MortgageRates
# import csv
...
# def import_mean_house_value_of_suburbs_CHCH(request):
#     folder_path = 'D:\\workspace\\data\\mean house price by suburb\\*.csv'
...
#             print(csv_file)
#             for row in csv_reader:
#                 # existing_record = MeanHouseValueSuburbsCHCH.objects.get('primary_key_of_suburbs_CHCH')
#                 # if existing_record.exists():
#                 #     print(f"Error: Record with primary key {'primary_key_of_suburbs_CHCH'} already exists.")
#                 # else:
...
#             #         price = row['price']
#             #     )
#             #     check_exists = MeanHouseValueSuburbsCHCH.objects.get('primary_key_of_suburbs_CHCH'=primary_key_of_suburbs_CHCH)
